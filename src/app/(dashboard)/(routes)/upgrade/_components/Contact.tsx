...
const Contact = () => {
  return (
    ...
    <div className="flex flex-col justify-center w-full p-8 lg:bg-gray-100 lg:px-12 xl:px-32 lg:w-1/2">
        <h1 className="text-2xl font-semibold text-gray-800 capitalize  lg:text-3xl">Ask us</h1>
        ...
        <div className="mt-6 md:mt-8">
            ...
            <div className="flex mt-4 -mx-1.5 ">
                <h3 className="mx-1.5 cursor-pointer  text-gray-400 transition-colors duration-300 transform hover:text-primary" href="#">
    ...
    <div className="flex flex-col justify-center w-full p-8 pt-0 lg:w-1/2 lg:px-12 xl:px-24 ">
        <form>
            ...
            <div className="w-full mt-4">
                ...
                <textarea className="block resize-none w-full h-32 px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md md:h-56  focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Message"></textarea>
            </div>

            <button className="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-primary rounded-md hover:bg-slate-800 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                get in touch
            </button>
        </form>
    </div>
